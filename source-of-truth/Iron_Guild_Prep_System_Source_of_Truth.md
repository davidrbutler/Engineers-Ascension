...
Do **not** update this file just because a quest changes position on the roadmap.
...
- **Iron Guild Roadmap — Source of Truth**: owns sequencing and progression
...
- create a new versioned snapshot only when the document is meaningfully stabilized,
- avoid creating side files unless they have a clearly different job.
...
- and presentation-layer development is intentionally deferred until after MVP
...
- and templates externalize structure without replacing understanding
...
- “I must clear everything under full pressure to deserve progress.”
